<template>
    <div class="container">
        <div class="header">
            <div class="back">
                <router-link :to="{ path: '/'+addressUrl,query:{partnerStoreNo:partnerStoreNo,clientId:clientId, address: address}}" class="iconfont">&#xe611;</router-link>
            </div>
            <div class="title">家庭信息</div>
            <!-- <div class="write" @click="">编辑</div> -->
        </div>
        <div class="main">
             <ul class="familyList">
