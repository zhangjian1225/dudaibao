            ...
            <ul class="ulList">
                ...
                <li class="listBox" @click="clickCardId">
                    <div class="main_ipt">
                        ...
                        <div class="box">
                            <input type="text" placeholder="请输入证件号码" :readonly="nocanIpt" v-model="cardId" onKeyUp="value=value.replace(/[\W^\_]/g,'')" @blur="cardIdBlur">
                        </div>
                    </div>
                ...
                <li class="listBox" @click="dateFn">
                    <div class="main_ipt">
                        ...
                        <div class="box">
                            <input class="noUserSelect" type="text" readonly="readonly" placeholder="请选择出生日期" :value="birthday">
                        </div>
                        <span class="icon iconfont">&#xe61b;</span>
                    </div>
                </li>
                <li class="listBox"  @click="sexFn">
                    <div class="main_ipt">
                        ...
                        <div class="box">
                            <input class="noUserSelect" type="text" readonly="readonly" placeholder="请选择客户性别"  :value="sexDesc"/>
                        </div>
                        <span class="icon iconfont">&#xe61b;</span>
                    </div>
                </li>
                <li class="listBox" @click="changeArea">
                    <div class="main_ipt">
                        ...
                        <div class="box">
                            <input class="noUserSelect" type="text" readonly="readonly" placeholder="请选择客户住址" :value="provinceDesc&&cityDesc&&areaDesc?provinceDesc+'-'+cityDesc+'-'+areaDesc:''"/>
                        </div>
                        <span class="icon iconfont">&#xe61b;</span>
                    </div>
                </li>
                ...
                <li class="listBox" @click="userFormFn">
                    <div class="main_ipt">
                        <span class="name">客户来源</span>
                        <div class="box">
                            <input class="noUserSelect" type="text" readonly="readonly" placeholder="请选择客户来源" v-model="sourceDesc"/>
                        </div>
                    </div>
                </li>
            </ul>
