<template>
    <div class="container" id="pdfDom">
        <div class="header">
            <div class="back">
                <router-link :to="{ path: '/'+address,query:{clientId:clientId}}" class="iconfont">&#xe611;</router-link>
            </div>
        ...
        <div class="main">
            ...
            <ul class="ulListBox">
                ...
                <li class="initInfo">
                    <router-link :to="{ path: '/shequhuokeInitInfo',query:{clientId:clientId, address: address}}">
                        <span class="title">基本信息</span>
                        <span class="icon iconfont">&#xe61b;</span>
                    </router-link>
                </li>
                <li class="initInfo">
                    <router-link :to="{ path: '/shequhuokeFamilyInfo',query:{clientId:clientId, address: address}}">
                        <span class="title">家庭信息</span>
                        <span class="icon iconfont">&#xe61b;</span>
                    </router-link>
                </li>
                <li class="initInfo">
                    <router-link :to="{ path: '/shequhuokeCarInfo',query:{clientId:clientId, address: address}}">
                        <span class="title">车辆信息</span>
                        <span class="icon iconfont">&#xe61b;</span>
                    </router-link>
                </li>
                <li class="initInfo">
                    <router-link :to="{ path: './shequhuokebaodanInfo',query:{clientId:clientId, address: address}}">
                        <span class="title">保单记录</span>
                        <span class="icon iconfont">&#xe61b;</span>
                    </router-link>
                </li>
                <li class="initInfo">
                    <router-link :to="{ path: './goutongjilu',query:{clientId:clientId,address:address, addressBack:'shequhuokeUserInfo'}}">
                        <span class="title">沟通记录</span>
                        <span class="icon iconfont">&#xe61b;</span>
                    </router-link>
                </li>
                <li class="initInfo">
                    <router-link :to="{ path: './kehudongtai',query:{clientId:clientId,address:address, addressBack:'shequhuokeUserInfo'}}">
                        <span class="title">获得动态</span>
                        <span class="icon iconfont">&#xe61b;</span>
                    </router-link>
                </li>
            </ul>
